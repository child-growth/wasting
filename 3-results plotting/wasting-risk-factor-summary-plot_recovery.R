...
#Plot parameters
textcol <- "grey20"
plottitle="Relative risk of recovery from wasting within 90 days"
...
ggsave(hm2, file="Wasting_RF_heatmap_recovery_.png", width=9.2, height=5.6)
...
ggsave(hm3, file="Wasting_RF_heatmap_greyNA_recovery_.png", width=9.2, height=5.6)
...
ggsave(hm4, file="Wasting_RF_heatmap_justsig_recovery_.png", width=9.2, height=5.6)
...
ggsave(hm5, file="Wasting_RF_heatmap_justsig_lable_recovery_.png", width=9.2, height=5.6)
