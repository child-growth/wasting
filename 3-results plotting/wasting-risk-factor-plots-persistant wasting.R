...
#RMAest$agecat[grepl(" \\(no birth st\\.\\)\\\npersistant wasting",RMAest$agecat)] <- "cumulative incidence\n(no birth stunting)"


#RMAest$agecat <- factor(RMAest$agecat, levels = c("0-6 month\npersistant wasting","6 month prevalence", "6-24 month\npersistant wasting", "24 month prevalence"))
RMAest$agecat <- factor(RMAest$agecat, levels=c("3 months prevalence", "3-6 months\npersistant wasting", "0-6 months (no birth wast)\npersistant wasting","0-6 months\npersistant wasting",
                                                "6 months prevalence","6-9 months\npersistant wasting","9 months prevalence","9-12 months\npersistant wasting","12 months prevalence",
                                                "12-15 months\npersistant wasting","15 months prevalence","15-18 months\npersistant wasting","18 months prevalence",
                                                "0-24 months (no birth wast)","6-24 months\npersistant wasting","0-24 months (no birth wast)\npersistant wasting","0-24 months\npersistant wasting","24 months prevalence"))
...
pdf("Persistant wasting/Risk Factor Plots persistant Wasting", height=8, width=12)
...
for(i in levels(RMAest$intervention_variable)){
  ...
  if(nrow(plotdf)>0){
    ...
    ggsave(p, file=paste0("Persistant wasting/",j,"_",i,"_RFplot.png"), width=5.7, height=4.6)
...
# df$agecat <- gsub("\npersistant wasting", " CI", df$agecat)
