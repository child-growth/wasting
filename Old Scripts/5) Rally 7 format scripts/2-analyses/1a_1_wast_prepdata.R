...
#d<-fread("U:/data/Wasting/Full-compiled-data/FINAL.csv", header = T)
# dim(d)
# head(d)
# colnames(d)
# saveRDS(d, "FINAL.rds")
...
d<-d %>% subset(., select=c(studyid, subjid, country, tr, agedays, whz))
...
#--------------------------------------------
# Save just identifying and whz data
#--------------------------------------------
...
#--------------------------------------------
# drop trial arms with intervention impact on whz
...
#--------------------------------------------
# plot whz by agedays for included studies
#--------------------------------------------
