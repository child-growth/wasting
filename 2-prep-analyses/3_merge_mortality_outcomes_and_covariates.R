...
load("U:/ucb-superlearner/Co-occurrence/co_prev_mortality.RData")
dim(d)
...
save(d, file="U:/UCB-SuperLearner/Wasting rallies/stuntwast_mort.Rdata")
...
d <- d %>% subset(., select = -c(
  ever_sstunted06,     ever_wasted024,      ever_swasted024,     pers_wasted024,      ever_stunted024,     ever_sstunted024, 
  ever_swasted06_noBW, ever_wasted024_noBW, ever_swasted024_noBW,  ever_sunderweight06, ever_underweight024, ever_sunderweight024, ever_co024))
