...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/shared/waz_QA_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/waz_QA_cohort_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/laz_QA_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/laz_QA_cohort_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/wlz_QA_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/wlz_QA_cohort_monthly.png"))
```
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/shared/waz_secular_trend_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/laz_secular_trend_monthly.png"))
include_graphics(paste0(BV_dir,"/shared/wlz_secular_trend_monthly.png"))
