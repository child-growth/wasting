...
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/WLZ_by_region-no-Kenaba-BW.png"))
```
...
# include_graphics(paste0(fig_dir, "wasting/no-kenaba-bw/fig-wast-2-prev-overall_region--allage-primary-no-Kenaba-BW.png"))
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-wast-prev-no-Kenaba-BW.png"))
```
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-wast-ci-no-Kenaba-BW.png"))
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-wast-ir-no-Kenaba-BW.png"))
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-wast-rec-no-Kenaba-BW.png"))
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-sev-wast-no-Kenaba-BW.png"))
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-pers-wast-no-Kenaba-BW.png"))
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-co-prev-no-Kenaba-BW.png"))
...
```{r, echo = FALSE}
include_graphics(paste0(BV_dir,"/wasting/no-kenaba-bw/fig-uw-prev-no-Kenaba-BW.png"))
