...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-2-prev-overall_region--allage-primary}

\hypertarget{fixed-effects-1}{%
\subsection{Fixed effects}\label{fixed-effects-1}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/FE/fig-wast-2-prev-overall_region--allage-primary_FE}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-2-cuminc-overall_region--allage-primary}

\hypertarget{fixed-effects-2}{%
\subsection{Fixed effects}\label{fixed-effects-2}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/FE/fig-wast-2-cuminc-overall_region--allage-primary_FE}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-2-ir-overall_region--allage-primary}

\hypertarget{fixed-effects-3}{%
\subsection{Fixed effects}\label{fixed-effects-3}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/FE/fig-wast-2-ir-overall_region--allage-primary_FE}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-2-rec-overall_region--allage-primary}

\hypertarget{fixed-effects-4}{%
\subsection{Fixed effects}\label{fixed-effects-4}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/FE/fig-wast-2-rec-overall_region--allage-primary_FE}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-3-prev-overall_region--allage-primary}

\hypertarget{fixed-effects-5}{%
\subsection{Fixed effects}\label{fixed-effects-5}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/FE/fig-wast-3-prev-overall_region--allage-primary_FE}
...
\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//wasting/pooled_pers024}

\hypertarget{fixed-effects-6}{%
\subsection{Fixed effects}\label{fixed-effects-6}}

\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//wasting/pooled_pers024_FE}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-2-co-overall_region--allage-primary}

\hypertarget{fixed-effects-7}{%
\subsection{Fixed effects}\label{fixed-effects-7}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/FE/fig-wast-2-co-overall_region--allage-primary_FE}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-prev_plot_africa}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-prev_plot_lam}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-prev_plot_sasia}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-sevwast_plot_africa}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-sevwast_plot_lam}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-sevwast_plot_sasia}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-perswast_plot_africa}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-perswast_plot_lam}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-perswast_plot_sasia}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-co_plot_africa}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-co_plot_lam}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-co_plot_sasia}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-underweight_plot_africa}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-underweight_plot_lam}
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/fig-underweight_plot_sasia}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/WLZ_by_region-no-Kenaba-BW}

\hypertarget{age-specific-prevalence-2}{%
\section{Age-specific prevalence}\label{age-specific-prevalence-2}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-wast-prev-no-Kenaba-BW}

\hypertarget{age-specific-incidence-1}{%
\section{Age-specific incidence}\label{age-specific-incidence-1}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-wast-ci-no-Kenaba-BW}

\hypertarget{age-specific-incidence-rate-1}{%
\section{Age-specific incidence rate}\label{age-specific-incidence-rate-1}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-wast-ir-no-Kenaba-BW}

\hypertarget{age-specific-recovery-1}{%
\section{Age-specific recovery}\label{age-specific-recovery-1}}

\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-wast-rec-no-Kenaba-BW}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-sev-wast-no-Kenaba-BW}
...
\includegraphics[width=41.67in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-pers-wast-no-Kenaba-BW}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-co-prev-no-Kenaba-BW}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/no-kenaba-bw/fig-uw-prev-no-Kenaba-BW}
...
\includegraphics[width=58.33in]{/data/KI/ki-manuscript-output/figures//wasting/fig-wast-2-muac-overall_region--allage-primary}
...
\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//shared/waz_QA_monthly}
\includegraphics[width=104.17in]{/data/KI/ki-manuscript-output/figures//shared/waz_QA_cohort_monthly}
\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//shared/laz_QA_monthly}
\includegraphics[width=104.17in]{/data/KI/ki-manuscript-output/figures//shared/laz_QA_cohort_monthly}
\includegraphics[width=104.17in]{/data/KI/ki-manuscript-output/figures//shared/wlz_QA_monthly}
\includegraphics[width=104.17in]{/data/KI/ki-manuscript-output/figures//shared/wlz_QA_cohort_monthly}
...
\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//shared/waz_secular_trend_monthly}
\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//shared/laz_secular_trend_monthly}
\includegraphics[width=33.33in]{/data/KI/ki-manuscript-output/figures//shared/wlz_secular_trend_monthly}
