...
save(prev.data, ci.data, ci.data.nobirth, rec.data, ir.data, ir.data.nobirth, rec.ir.data, dur.data, file="C:/Users/andre/Documents/HBGDki/Results/Wasting_descriptive_epi_results.Rdata")
